...
<body>    
    ...
    <div class="container">
        ...
        <input type="text" class="form-control mb-3" placeholder="Enter category" value="<?php echo $r["CNAME"] ;?>" name="cname">
        <button type="submit" name="btn4"  class="btn3 btn btn-success">EDIT</button>
        </form>
                </div>
                </div>
            </div>
